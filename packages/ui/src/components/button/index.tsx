...
const buttonVariants = cva(
  // Base: siempre visible el ring de foco (WCAG 2.4.7 — Foco visible)
  [
...
/**
 * Button — Botón base del sistema de diseño OLAAC.
 * Usa Radix Slot para composición; foco visible cumple WCAG 2.4.7.
 */
